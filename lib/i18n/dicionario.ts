...
export const DICIONARIO: Traducoes = {
  ...
  "Nenhum serviço de remoção cadastrado ainda": { es: "Todavía no hay ningún servicio de remoción registrado" },
  "Enquanto não houver serviço cadastrado, o cálculo de orçamento de remoção não encontra a modalidade pedida.": { es: "Mientras no haya un servicio registrado, el cálculo de presupuesto de remoción no encuentra la modalidad pedida." },
  "Buscar por nome ou código": { es: "Buscar por nombre o código" },
  "Novo serviço": { es: "Nuevo servicio" },
  ...
  "Cobrada uma vez por chamada, sempre — some ao valor da ida/ida-e-volta ou ao cálculo por km.": { es: "Se cobra una vez por llamada, siempre — se suma al valor de ida/ida y vuelta o al cálculo por km." },
  "Valor por km": { es: "Valor por km" },
  "A partir de quantos km cobra por km": { es: "A partir de cuántos km se cobra por km" },
  "Abaixo deste km, o orçamento usa o valor da ida (ou ida e volta). A partir dele, usa o valor por km — os dois nunca somam.": { es: "Por debajo de este km, el presupuesto usa el valor de ida (o ida y vuelta). A partir de él, usa el valor por km — los dos nunca se suman." },
  "Salvar serviço": { es: "Guardar servicio" },
  "Serviço atualizado": { es: "Servicio actualizado" },
  "Serviço cadastrado": { es: "Servicio registrado" },
  "Serviço excluído": { es: "Servicio eliminado" },
  "Serviço desativado": { es: "Servicio desactivado" },
  "Serviço reativado": { es: "Servicio reactivado" },
  "Valor da ida inválido. Escreva assim: 250,00": { es: "Valor de ida inválido. Escribe así: 250,00" },
  "Valor de ida e volta inválido.": { es: "Valor de ida y vuelta inválido." },
  "Taxa de saída inválida.": { es: "Tarifa de salida inválida." },
  "Valor do km inválido.": { es: "Valor del km inválido." },
  "Limiar de km inválido.": { es: "Umbral de km inválido." },
  "ida": { es: "ida" },
  "ida e volta": { es: "ida y vuelta" },
  "por km após": { es: "por km después de" },
  "km": { es: "km" },
  // --- crm_calculate_removal_quote / Chave de mapa / Preço por km (migration 0232) ---
  "Credencial salva. Testando…": { es: "Credencial guardada. Probando…" },
  "Credencial salva. Teste em segundo plano.": { es: "Credencial guardada. Prueba en segundo plano." },
  "Chave validada — o cálculo de distância já pode usá-la.": { es: "Clave validada — el cálculo de distancia ya puede usarla." },
  "Validação falhou": { es: "La validación falló" },
  "Adicionar credencial de mapa": { es: "Agregar credencial de mapa" },
  "A chave é cifrada (AES-GCM) antes de gravar e nunca é retornada em texto claro. Crie uma chave gratuita em openrouteservice.org.": { es: "La clave se cifra (AES-GCM) antes de guardarse y nunca se devuelve en texto claro. Crea una clave gratuita en openrouteservice.org." },
  "Label": { es: "Etiqueta" },
  "Chave da OpenRouteService": { es: "Clave de OpenRouteService" },
  "Salvar e testar": { es: "Guardar y probar" },
  "Testando a chave…": { es: "Probando la clave…" },
  "Testar credencial": { es: "Probar credencial" },
  "O cálculo de distância de remoção para de funcionar até outra chave ser cadastrada. Esta ação não pode ser desfeita.": { es: "El cálculo de distancia de remoción deja de funcionar hasta que se registre otra clave. Esta acción no se puede deshacer." },
  "Nenhuma chave de mapa cadastrada ainda": { es: "Todavía no hay ninguna clave de mapa registrada" },
  "Sem uma chave da OpenRouteService, o cálculo de distância de remoção não funciona — crie uma conta gratuita em openrouteservice.org e cole a chave aqui.": { es: "Sin una clave de OpenRouteService, el cálculo de distancia de remoción no funciona — crea una cuenta gratuita en openrouteservice.org y pega la clave aquí." },
  "Chave de mapa (distância)": { es: "Clave de mapa (distancia)" },
  "Usada pro cálculo de distância de remoção (endereço de origem até o destino). Crie uma conta gratuita em openrouteservice.org e cole a chave aqui — ela é guardada criptografada.": { es: "Se usa para el cálculo de distancia de remoción (dirección de origen hasta el destino). Crea una cuenta gratuita en openrouteservice.org y pega la clave aquí — se guarda cifrada." },
  // --- Conexões MCP externas, por organização (migration 0236) ---
  "URL inválida": { es: "URL inválida" },
  "Precisa começar com https://": { es: "Tiene que empezar con https://" },
  "Chave muito curta": { es: "Clave demasiado corta" },
  "Conectar a outro sistema": { es: "Conectar con otro sistema" },
  "Conectar a outro sistema (MCP)": { es: "Conectar con otro sistema (MCP)" },
  "Conexão salva. Testando…": { es: "Conexión guardada. Probando…" },
  "Conexão salva. Teste em segundo plano.": { es: "Conexión guardada. Prueba en segundo plano." },
  "Conectado — já achamos as ferramentas desse sistema.": { es: "Conectado — ya encontramos las herramientas de ese sistema." },
  "Conexão falhou": { es: "La conexión falló" },
  "Testar conexão": { es: "Probar conexión" },
  "Excluir conexão": { es: "Eliminar conexión" },
  "Remover conexão": { es: "Quitar conexión" },
  "Testando a conexão…": { es: "Probando la conexión…" },
  "Conexão removida.": { es: "Conexión eliminada." },
  "O agente desta empresa não vai mais conseguir usar este sistema. Esta ação não pode ser desfeita.": { es: "El agente de esta empresa ya no va a poder usar este sistema. Esta acción no se puede deshacer." },
  "Nenhuma conexão cadastrada ainda": { es: "Todavía no hay ninguna conexión registrada" },
  "Conecte outro sistema que fale o protocolo MCP — cole a URL e a chave que esse sistema te deu.": { es: "Conecta otro sistema que hable el protocolo MCP — pega la URL y la clave que ese sistema te dio." },
  "Adicionar conexão": { es: "Agregar conexión" },
  "Cole a URL e a chave de outro sistema que fale o protocolo MCP. Testamos a conexão de verdade e listamos o que ele oferece.": { es: "Pega la URL y la clave de otro sistema que hable el protocolo MCP. Probamos la conexión de verdad y listamos lo que ofrece." },
  "Conectada": { es: "Conectada" },
  "ferramenta encontrada": { es: "herramienta encontrada" },
  "ferramentas encontradas": { es: "herramientas encontradas" },
  "A chave é cifrada (AES-GCM) antes de gravar e nunca é retornada em texto claro. A URL precisa ser https e pública — endereços internos são recusados.": { es: "La clave se cifra (AES-GCM) antes de guardarse y nunca se devuelve en texto claro. La URL tiene que ser https y pública — direcciones internas son rechazadas." },
  "URL do MCP": { es: "URL del MCP" },
  "Ex: Sistema de estoque": { es: "Ej: Sistema de inventario" },
  // --- Conexões MCP no editor de agente (2026-09-10) ---
  "Outros sistemas que ele pode usar": { es: "Otros sistemas que puede usar" },
  "Marque as conexões que este assistente pode chamar durante a conversa, além do que ele já faz aqui dentro.": { es: "Marca las conexiones que este asistente puede llamar durante la conversación, además de lo que ya hace aquí dentro." },
  "Você ainda não conectou nenhum sistema externo.": { es: "Todavía no conectaste ningún sistema externo." },
  "Conecte um em Outros sistemas": { es: "Conecta uno en Otros sistemas" },
  "para poder liberar o assistente.": { es: "para poder habilitarlo en el asistente." },
  "— conexão falhando": { es: "— conexión fallando" },
  "— conectada": { es: "— conectada" },
  "— ainda não testada": { es: "— todavía no probada" },
  "Sem nenhuma conexão marcada, ele conversa normalmente, mas não chama ferramenta de nenhum outro sistema.": { es: "Sin ninguna conexión marcada, conversa normalmente, pero no llama ninguna herramienta de otro sistema." },
  "está marcada mas a conexão não está confiável agora — o assistente vai tentar chamar e vai falhar em silêncio.": { es: "está marcada pero la conexión no es confiable ahora — el asistente va a intentar llamarla y va a fallar en silencio." },
  "conexões marcadas não estão confiáveis agora — o assistente vai tentar chamar e vai falhar em silêncio.": { es: "conexiones marcadas no son confiables ahora — el asistente va a intentar llamarlas y va a fallar en silencio." },
  "Preço por km inválido.": { es: "Precio por km inválido." },
  "Produto atualizado": { es: "Producto actualizado" },
  "Produto excluído": { es: "Producto eliminado" },
  "Editar produto": { es: "Editar producto" },
  "Copiar produto": { es: "Copiar producto" },
  "Detalhes do produto": { es: "Detalles del producto" },
  "O código não muda depois de criado.": { es: "El código no cambia después de creado." },
  "Preço por km rodado": { es: "Precio por km recorrido" },
