...
function versionPayloadFrom(src: Record<string, unknown>) {
  return {
    ...
    // Mesmo defeito de propósito descrito acima, mesma correção: sem isto, o
    // clone nasce sem acesso a nenhum sistema externo que o original tinha —
    // e o dono descobre isso quando o clone tenta chamar uma ferramenta que
    // ele achava que já estava marcada.
