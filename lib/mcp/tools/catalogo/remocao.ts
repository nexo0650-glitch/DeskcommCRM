...
export const TOOLS_REMOCAO = declararTools([
  {
    ...
    explicacao:
      "Calcula o preço exato de uma remoção a partir do endereço de origem e destino, somando o valor fixo da modalidade com o valor por km rodado — para o assistente nunca chutar distância nem preço.",
